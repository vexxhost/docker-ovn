...
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/bin/ovs-appctl /usr/bin/ovs-appctl
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/bin/ovs-ofctl /usr/bin/ovs-ofctl
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/bin/ovs-vsctl /usr/bin/ovs-vsctl
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/bin/ovsdb-client /usr/bin/ovsdb-client
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/sbin/ovsdb-server /usr/sbin/ovsdb-server
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/bin/ovsdb-tool /usr/bin/ovsdb-tool
COPY --from=ghcr.io/vexxhost/openvswitch:latest@sha256:b455ac256c4b0b869154858897658ea84e62b3ebe628c56b9c4c15b62ef06672 /usr/share/openvswitch/scripts /usr/share/openvswitch/scripts
